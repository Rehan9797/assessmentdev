...
function validateEmail(){
    if(email.value.trim()==""){
        ...
        email.style.border="2px solid red "
        err1.innerText="Email is Not in Correct "
        return false
    }else{
        err1.innerText=""
...
function validatePhone(){
    if(phonenumber.value.trim()==""){
        ...
        phonenumber.style.border="2px solid red "
        err2.innerText="Incorrect Number"
        return false
    }else if(phonenumber.value.length<10){
        phonenumber.style.border="2px solid red "
        err2.innerText="Must  Have 10 digits"
        return false
    }else{
        err2.innerText=""
...
function validatePass(){
    if(pass.value.trim()==""){
        ...
        err3.innerText="Password Must Contain 8 charecters";
        pass.style.border="2px solid red "
        return false
    }else if (pass.value.match(regex3)){
        err3.innerText="Password Is Not  Correct ";
        pass.style.border="2px solid red "
        return false
    }else{
        err3.innerText=""
